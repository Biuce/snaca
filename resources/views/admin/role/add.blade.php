                    ...
                    <div class="row row-10 align-items-center" style="margin-top:40px;">
                        @if(isset($id))
                            <div class="col-sm-12 text-sm-center">
                                <button class="btn btn-primary" type="submit" lay-submit lay-filter="formAdminUser" id="submitBtn">{{trans('role.editRole')}}</button>
                        ...
                        @else
                            <div class="col-sm-12 text-sm-center">
                                <button class="btn btn-primary" type="submit" lay-submit lay-filter="formAdminUser" id="submitBtn">{{trans('role.createRole')}}</button>
                                <div style="display:inline;float:right;">
