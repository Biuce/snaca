            ...
            <div class="panel-header">
                <div class="d-flex flex-wrap align-items-center justify-content-between group-5">
                    ...
                    <div class="form-group">
                        <a href="{{ route('admin::menu.create') }}"><button class="btn btn-primary" type="button" id="submitBtn">{{trans('menu.createMenu')}}</button></a>
                    </div>
                </div>

                <div style="margin-top: 20px;">
                    <form name="admin_list_sea" class="form-search" method="get" action="{{ route('admin::menu.index') }}">
                        {{ csrf_field() }}
                        <div class="row row-15">
                            <div class="col-sm-2">
                                <div class="input-group">
                                    <input class="form-control" id="text" type="text" placeholder="{{ trans('menu.name') }}" name="name">
                                </div>
                            </div>
                            <div class="col-sm-2">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button class="btn btn-primary" onclick="deleteMenu('{{ route('admin::menu.delete', ['id' => $v['id']]) }}')">{{trans('general.confirm')}}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
