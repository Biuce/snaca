                ...
                <form method="post" action="@if(isset($id)){{ route('admin::config.update', ['id' => $id]) }}@else{{ route('admin::config.save') }}@endif" id="config_add">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="row form-group">
                             ...
                             <div class="col-sm-11">
                                  <div class="input-group form-group">
                                       <input class="form-control" type="text" name="key" placeholder="数字字母或下划线组成，长度不超过100" aria-describedby="icon-addon1" value="{{ $model->key ?? ''  }}">
                                  </div>
                             </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-11">
                                <div class="input-group form-group">
                                    <textarea class="form-control" id="standardTextarea" rows="3" name="value"> {{ $model->value ?? ''  }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-11">
                                <div class="input-group form-group">
                                    <input class="form-control" type="text" name="group" aria-describedby="icon-addon1" value="{{ $model->group ?? ''  }}" id="group">
                                </div>
                            </div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row row-10 align-items-center">
                            @if(isset($id))
                                <div class="col-sm-12 text-sm-center">
                                    <button class="btn btn-primary" type="submit" lay-submit lay-filter="formAdminUser" id="submitBtn">{{trans('config.editConfig')}}</button>
                            ...
                            @else
                                <div class="col-sm-12 text-sm-center">
                                    <button class="btn btn-primary" type="submit" lay-submit lay-filter="formAdminUser" id="submitBtn">{{trans('config.newConfig')}}</button>
                                    <div style="display:inline;float:right;">
